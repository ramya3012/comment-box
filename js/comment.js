...
// to get the comment list conatiner so that we can use the event delegation
...
// // update a comment button
let createUpdateCommentView = (id, operationType, commentOldData) => {
...
let singleCommentCard = (obj, padding) => `
    <div style="background-color: antiquewhite; margin-left: ${padding}px; border: 2px solid green; width: 400px; height:40px; padding:4px;text-align:center;border-radius: 10px;" data-parentId="${
	obj.parentCommentId
}" id="${obj.commentId}">
    ${obj.commentText}
